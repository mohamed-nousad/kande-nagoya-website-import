...
export const HEADER_BG_DEFAULT_COLOR_DARK = '#1a1a2e';
export const LAYOUT_CONTENT_GUTTER = 25;
export const LAYOUT_CONTENT_GUTTER_SM = 15;
export const SIDE_NAV_DARK_BG_COLOR = '#0d0d1a';

export const PRIMARY_BASE   = '#0096DB';
...
export const DARK          = '#080422';
export const GRAY_DARK     = '#080422';
...
export const DARK_MODE = {
    TEXT_COLOR:        '#b4bed2',
    HEADING_COLOR:     '#080422',
    BG_COLOR:          '#1a1a2e',
    BORDER_BASE_COLOR: '#4d5b75',
    HOVER_BG_COLOR:    '#0096DB',
    ACTIVE_BG_COLOR:   '#b02a37',
