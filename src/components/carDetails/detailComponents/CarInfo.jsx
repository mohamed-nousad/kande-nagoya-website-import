...
export default function CarInfo({ vehicle }) {
  return (
    <>
      <div className="icon-box flex flex-wrap">
        <div className="icons flex-three">
          <i className="icon-autodeal-km1 me-2" />
          <span>{vehicle?.milage.toLocaleString()} kms</span>
        </div>
        <div className="icons flex-three">
          <i className="icon-autodeal-diesel me-2" />
          <span>{vehicle?.fuel}</span>
        </div>
        <div className="icons flex-three">
          <i className="icon-autodeal-automatic me-2" />
          <span>{vehicle?.transmission}</span>
        </div>
        <div className="icons flex-three">
          <i className="icon-autodeal-owner me-2" />
          <span>1st owner</span>
        </div>
      </div>
      <div className="money text-color-3 font">
        {vehicle?.purchaseAmount?.toLocaleString() + ".00"}
      </div>
      <div className="price-wrap">
        <p className="fs-12 lh-16 text-color-2">
          Monthly installment payment:
