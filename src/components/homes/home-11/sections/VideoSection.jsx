    ...
    <section className="video-section">
      ...
      <div className="container-wide video-grid">
        <div className="video-main">
          <img src="/assets/images/home-11/video-main.png" alt="Car review video" />
          <button type="button" className="play" aria-label="Play video">&#9654;</button>
        </div>
        <div className="video-side">
          <div className="video-small">
            <img src="/assets/images/home-11/blog-1.png" alt="BMW versus Mercedes review" />
          </div>
          <div className="video-small">
            <img src="/assets/images/home-11/blog-2.png" alt="Honda city review" />
          </div>
        </div>
      </div>
